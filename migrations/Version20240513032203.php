...
final class Version20240513032203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO unidade_conversao (descricao, valor, unidade_armazenamento_id) VALUES
            ...
            ('20L', 20, (select id from unidade_armazenamento where descricao = 'Litro')),
            ('395g', 0.395, (select id from unidade_armazenamento where descricao = 'Quilogramas')),
            ('400g', 0.4, (select id from unidade_armazenamento where descricao = 'Quilogramas')),
            ('500g', 0.5, (select id from unidade_armazenamento where descricao = 'Quilogramas')),
            ('1kg', 1, (select id from unidade_armazenamento where descricao = 'Quilogramas')),
            ('2kg', 2, (select id from unidade_armazenamento where descricao = 'Quilogramas')),
            ('5kg', 5, (select id from unidade_armazenamento where descricao = 'Quilogramas')),
            ('10kg', 10, (select id from unidade_armazenamento where descricao = 'Quilogramas'))");
